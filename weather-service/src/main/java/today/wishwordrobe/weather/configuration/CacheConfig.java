...
public class CacheConfig {
    ...
    public CacheManager cacheManager(ReactiveRedisConnectionFactory connectionFactory) {
        ...
        cacheConfigurations.put(WEATHER_CACHE, defaultConfig.entryTtl(Duration.ofHours(3)));
        cacheConfigurations.put(UV_INDEX_CACHE, defaultConfig.entryTtl(Duration.ofHours(24)));
        cacheConfigurations.put(AIR_QUALITY_CACHE, defaultConfig.entryTtl(Duration.ofHours(1)));
        cacheConfigurations.put(INTEGRATED_WEATHER_CACHE, defaultConfig.entryTtl(Duration.ofHours(1)));
