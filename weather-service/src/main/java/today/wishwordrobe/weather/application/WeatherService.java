        ...
        private WeatherForecastDTO convertToWeatherForecastDTO(VillageForecastResponse response, Geographic location) {
            ...
            for(VillageForecastResponse.Item item: items.getItem()){
                ...
                switch (category){
                    ...
                    case "SKY":  // 하늘상태
                        switch (value) {
                            case "1": builder.skyCondition("맑음"); break;
                            case "3": builder.skyCondition("구름많음"); break;
                            case "4": builder.skyCondition("흐림"); break;
                        }
                        break;
                    case "PTY":  // 강수형태
                        switch (value) {
                            case "0": builder.precipitationType("없음"); break;
                            case "1": builder.precipitationType("비"); break;
                            case "2": builder.precipitationType("비/눈"); break;
                            case "3": builder.precipitationType("눈"); break;
                            case "4": builder.precipitationType("소나기"); break;
                        }
                        break;
                }
                //한번만 설정
